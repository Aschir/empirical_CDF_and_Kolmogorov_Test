...
Use **bootstrap resampling** to estimate confidence intervals for means, medians, regression coefficients, ... 
Implement the procedure manually and compare with R’s `boot` package.  
